...
File generated at Fri Nov 14 17:18:22 2014
...
mech9 = Physic.Mechanic('planeStrain')
mech9.addRegions(['cantilever'])
mech9.addBc(mech9.BC.Fix('left_edge', ['x', 'y']))
modal1.addPhysic(mech9)
