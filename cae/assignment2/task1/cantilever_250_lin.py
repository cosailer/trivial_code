...
File generated at Fri Nov 14 17:25:19 2014
...
simulation.setGrid('cantilever_250_lin.nmf', 'plane')
...
mech15 = Physic.Mechanic('planeStrain')
mech15.addRegions(['cantilever'])
mech15.addBc(mech15.BC.Fix('left_edge', ['x', 'y']))
modal1.addPhysic(mech15)
