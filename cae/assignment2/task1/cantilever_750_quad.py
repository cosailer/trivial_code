...
File generated at Fri Nov 14 17:19:19 2014
...
simulation.setGrid('cantilever_750_quad.nmf', 'plane')
...
mech10 = Physic.Mechanic('planeStrain')
mech10.addRegions(['cantilever'])
mech10.addBc(mech10.BC.Fix('left_edge', ['x', 'y']))
modal1.addPhysic(mech10)
