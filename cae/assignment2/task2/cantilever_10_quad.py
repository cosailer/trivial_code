...
File generated at Fri Nov 14 18:20:38 2014
...
simulation.setGrid('cantilever_10_quad.nmf', 'plane')
...
mech3 = Physic.Mechanic('planeStrain')
mech3.addRegions(['cantilever'])
mech3.addBc(mech3.BC.Fix('left_edge', ['x', 'y']))
mech3.addBc(mech3.BC.Force.expr('bot_right', 'y', "-5"))
mech3.addResult(mech3.Result.Displacement('top_right', 'amplPhase', 'mesh', [text]))
harm1.addPhysic(mech3)
